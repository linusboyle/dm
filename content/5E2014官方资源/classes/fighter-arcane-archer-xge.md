...
At 3rd level, you learn magical theory or some of the secrets of nature—typical for practitioners of this elven martial tradition. You choose to gain proficiency in either the [Arcana](5E2014官方资源/规则/skills.md#Arcana) or the [Nature](5E2014官方资源/规则/skills.md#Nature) skill, and you choose to learn either the [prestidigitation](5E2014官方资源/spells/prestidigitation.md) or the [druidcraft](5E2014官方资源/spells/druidcraft.md) cantrip.

### Arcane Shot (Level 3)

At 3rd level, you learn to unleash special magical effects with some of your shots. When you gain this feature, you learn two Arcane Shot options of your choice (see "Arcane Shot Options" below).

Once per turn when you fire an arrow from a shortbow or longbow as part of the [Attack](5E2014官方资源/规则/actions.md#Attack) action, you can apply one of your Arcane Shot options to that arrow. You decide to use the option when the arrow hits a creature, unless the option doesn't involve an attack roll. You have two uses of this ability, and you regain all expended uses of it when you finish a short or long rest.
...
> [!example]- Arcane Shot
> ![Arcane Shot](5E2014官方资源/optional-features/list-arcane-shot-xge.md#Arcane%20Shot)
^list-arcane-shot