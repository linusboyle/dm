...
- (a) a [quarterstaff](5E2014官方资源/items/quarterstaff.md) or (b) a [dagger](5E2014官方资源/items/dagger.md)  
- (a) a [component pouch](5E2014官方资源/items/component-pouch.md) or (b) an [arcane focus](5E2014官方资源/items/arcane-focus.md)  
- (a) a [scholar's pack](5E2014官方资源/items/scholars-pack.md) or (b) an [explorer's pack](5E2014官方资源/items/explorers-pack.md)  
- A [spellbook](5E2014官方资源/items/spellbook.md)  
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](5E2014官方资源/spells/magic-missile.md), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
You can use an [arcane focus](5E2014官方资源/items/arcane-focus.md) as a spellcasting focus for your wizard spells.
...
> 
> **Copying from a Spell Scroll.** A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When you copy a spell from a spell scroll, you must succeed on an Intelligence ([Arcana](5E2014官方资源/规则/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.
> 
...
*3rd-level wizard [optional class features](5E2014官方资源/规则/variant-rules/optional-class-features-tce.md)*
