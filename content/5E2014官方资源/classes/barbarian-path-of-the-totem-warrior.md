...
Yours is a path that seeks attunement with the natural world, giving you a kinship with beasts. At 3rd level when you adopt this path, you gain the ability to cast the [beast sense](5E2014官方资源/spells/beast-sense.md) and [speak with animals](5E2014官方资源/spells/speak-with-animals.md) spells, but only as rituals, as described in "chapter 10".
...
- **Eagle**  
    ...
    While you're raging and aren't wearing heavy armor, other creatures have disadvantage on opportunity attack rolls against you, and you can use the [Dash](5E2014官方资源/规则/actions.md#Dash) action as a bonus action on your turn. The spirit of the eagle makes you into a predator who can weave through the fray with ease.  
...
- **Eagle**  
    ...
    You gain the eyesight of an eagle. You can see up to 1 mile away with no difficulty, able to discern even fine details as though looking at something no more than 100 feet away from you. Additionally, dim light doesn't impose disadvantage on your Wisdom ([Perception](5E2014官方资源/规则/skills.md#Perception)) checks.  

- **Elk**  
    _Source: Sword Coast Adventurer's Guide p. 122_  

    Whether mounted or on foot, your travel pace is doubled, as is the travel pace of up to ten companions while they're within 60 feet of you and you're not [incapacitated](5E2014官方资源/规则/conditions.md#incapacitated). The elk spirit helps you roam far and fast.  

- **Tiger**  
    _Source: Sword Coast Adventurer's Guide p. 122_  

    You gain proficiency in two skills from the following list: [Athletics](5E2014官方资源/规则/skills.md#Athletics), [Acrobatics](5E2014官方资源/规则/skills.md#Acrobatics), [Stealth](5E2014官方资源/规则/skills.md#Stealth), and [Survival](5E2014官方资源/规则/skills.md#Survival). The cat spirit hones your survival instincts.  
...
At 10th level, you can cast the [commune with nature](5E2014官方资源/spells/commune-with-nature.md) spell, but only as a ritual. When you do so, a spiritual version of one of the animals you chose for Totem Spirit or Aspect of the Beast appears to you to convey the information you seek.
...
- **Bear**  
    ...
    While you're raging, any creature within 5 feet of you that's hostile to you has disadvantage on attack rolls against targets other than you or another character with this feature. An enemy is immune to this effect if it can't see or hear you or if it can't be [frightened](5E2014官方资源/规则/conditions.md#frightened).  
...
- **Elk**  
    ...
    While raging, you can use a bonus action during your move to pass through the space of a Large or smaller creature. That creature must succeed on a Strength saving throw (DC 8 + your Strength bonus + your proficiency bonus) or be knocked [prone](5E2014官方资源/规则/conditions.md#prone) and take bludgeoning damage equal to `1d12` + your Strength modifier.  
...
- **Wolf**  
    ...
    While you're raging, you can use a bonus action on your turn to knock a Large or smaller creature [prone](5E2014官方资源/规则/conditions.md#prone) when you hit it with melee weapon attack.