...
> 
> | Level | [Infusions Known](5E2014官方资源/optional-features/list-artificer-infusion-tce.md) | Infused Items | Cantrips Known | 1st | 2nd | 3rd | 4th | 5th |
> |-------|--------------------------------------------------------------------------------|---------------|----------------|-----|-----|-----|-----|-----|
> | 1st | ⏤ | ⏤ | 2 | 2 | ⏤ | ⏤ | ⏤ | ⏤ |
> | 2nd | 4 | 2 | 2 | 2 | ⏤ | ⏤ | ⏤ | ⏤ |
> | 3rd | 4 | 2 | 2 | 3 | ⏤ | ⏤ | ⏤ | ⏤ |
...
- **Weapons**: simple
- **Tools**: [thieves' tools](5E2014官方资源/items/thieves-tools.md), [tinker's tools](5E2014官方资源/items/tinkers-tools.md), one type of [artisan's tools](5E2014官方资源/items/artisans-tools.md) of your choice
- **Skills**: Choose 2 from *Arcana*, *History*, *Investigation*, *Medicine*, *Nature*, *Perception*, *Sleight of Hand*

You begin play with the following equipment, in addition to any equipment provided by your background.

- any two simple weapons of your choice  
- a [light crossbow](5E2014官方资源/items/light-crossbow.md) and [20 bolts](5E2014官方资源/items/crossbow-bolts-20.md)  
- (a) [studded leather armor](5E2014官方资源/items/studded-leather-armor.md) or (b) [scale mail](5E2014官方资源/items/scale-mail.md)  
- [thieves' tools](5E2014官方资源/items/thieves-tools.md) and a [dungeoneer's pack](5E2014官方资源/items/dungeoneers-pack.md)  
...
- **Armor**: light, medium, [shields](5E2014官方资源/items/shield.md)
- **Weapons**: none
- **Tools**: [thieves' tools](5E2014官方资源/items/thieves-tools.md), [tinker's tools](5E2014官方资源/items/tinkers-tools.md)
...
You've learned how to invest a spark of magic into mundane objects. To use this ability, you must have [thieves' tools](5E2014官方资源/items/thieves-tools.md) or [artisan's tools](5E2014官方资源/items/artisans-tools.md) in hand. You then touch a Tiny nonmagical object as an action and give it one of the following magical properties of your choice:
...
You produce your artificer spell effects through your tools. You must have a spellcasting focus—specifically [thieves' tools](5E2014官方资源/items/thieves-tools.md) or some kind of [artisan's tool](5E2014官方资源/items/artisans-tools.md)—in hand when you cast any spell with this Spellcasting feature (meaning the spell has an 'M' component when you cast it). You must be proficient with the tool to use it in this way. See "chapter 5", "Equipment," in the "Player's Handbook" for descriptions of these tools.

After you gain the Infuse Item feature at 2nd level, you can also use any item bearing one of your infusions as a spellcasting focus.

> [!note] The Magic of Artifice
> 
> As an artificer, you use tools when you cast your spells. When describing your spellcasting, think about how you're using a tool to perform the spell effect. If you cast [cure wounds](5E2014官方资源/spells/cure-wounds.md) using [alchemist's supplies](5E2014官方资源/items/alchemists-supplies.md), you could be quickly producing a salve. If you cast it using [tinker's tools](5E2014官方资源/items/tinkers-tools.md), you might have a miniature mechanical spider that binds wounds. When you cast [poison spray](5E2014官方资源/spells/poison-spray.md), you could fling foul chemicals or use a wand that spits venom. The effect of the spell is the same as for a spellcaster of any other class, but your method of spellcasting is special.
> 
> The same principle applies when you prepare your spells. As an artificer, you don't study a spellbook or pray to prepare your spells. Instead, you work with your tools and create the specialized items you'll use to produce your effects. If you replace [cure wounds](5E2014官方资源/spells/cure-wounds.md) with [heat metal](5E2014官方资源/spells/heat-metal.md), you might be altering the device you use to heal—perhaps modifying a tool so that it channels heat instead of healing energy.
> 
...
When you gain this feature, pick four artificer infusions to learn, choosing from the "[Artificer Infusions](5E2014官方资源/optional-features/list-artificer-infusion-tce.md)" section at the end of the class's description. You learn additional infusions of your choice when you reach certain levels in this class, as shown in the Infusions Known column of the Artificer table.
...
You've learned how to produce exactly the tool you need: with [thieves' tools](5E2014官方资源/items/thieves-tools.md) or [artisan's tools](5E2014官方资源/items/artisans-tools.md) in hand, you can magically create one set of [artisan's tools](5E2014官方资源/items/artisans-tools.md) in an unoccupied space within 5 feet of you. This creation requires 1 hour of uninterrupted work, which can coincide with a short or long rest. Though the product of magic, the tools are nonmagical, and they vanish when you use this feature again.
...
While holding the object, a creature can take an action to produce the spell's effect from it, using your spellcasting ability modifier. If the spell requires [concentration](5E2014官方资源/规则/conditions.md#concentration), the creature must concentrate. The spell stays in the object until it's been used a number of times equal to twice your Intelligence modifier (minimum of twice) or until you use this feature again to store a spell in an object.
...
> ![Artificer Infusion](5E2014官方资源/optional-features/list-artificer-infusion-tce.md#Artificer%20Infusion)
