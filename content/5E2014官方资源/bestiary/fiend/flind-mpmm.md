...
***Aura of Blood Thirst.*** If the flind isn't [incapacitated](5E2014官方资源/规则/conditions.md#incapacitated), any creature with the Rampage trait can make a Bite attack as a bonus action while within 10 feet of the flind.
...
***Flail of Paralysis.*** *Melee Weapon Attack:* `+9` to hit, reach 10 ft., one target. *Hit:* 10 (`1d10 + 5`) bludgeoning damage, and the target must succeed on a DC 16 Constitution saving throw or be [paralyzed](5E2014官方资源/规则/conditions.md#paralyzed) until the end of its next turn.
