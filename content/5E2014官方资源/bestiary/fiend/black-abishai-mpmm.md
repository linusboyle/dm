...
***Creeping Darkness (Recharge 6).*** The abishai casts [darkness](5E2014官方资源/spells/darkness.md) at a point within 120 feet of it, requiring no spell components or [concentration](5E2014官方资源/规则/conditions.md#concentration). Wisdom is its spellcasting ability for this spell. While the spell persists, the abishai can move the area of darkness up to 60 feet as a bonus action.
...
***Shadow Stealth.*** While in dim light or darkness, the abishai takes the [Hide](5E2014官方资源/规则/actions.md#Hide) action.
```
^statblock
