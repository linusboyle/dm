...
---
# Clay Golem
*Source: Monster Manual p. 168, The Book of Many Things. Available in the SRD.*  
...
***Slam.*** *Melee Weapon Attack:* `+8` to hit, reach 5 ft., one target. *Hit:* 16 (`2d10 + 5`) bludgeoning damage. If the target is a creature, it must succeed on a DC 15 Constitution saving throw or have its hit point maximum reduced by an amount equal to the damage taken. The target dies if this attack reduces its hit point maximum to 0. The reduction lasts until removed by the  [greater restoration](5E2014官方资源/spells/greater-restoration.md) spell or other magic.
