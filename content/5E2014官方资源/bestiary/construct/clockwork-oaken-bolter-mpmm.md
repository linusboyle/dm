...
|-----------|-------------|
| 1 | **Camouflaged.** The clockwork gains proficiency in [Stealth](5E2014官方资源/规则/skills.md#Stealth) if it lacks that proficiency. While motionless, it is indistinguishable from a stopped machine. |
| 2 | **Sensors.** The range of the clockwork's [darkvision](5E2014官方资源/规则/senses.md#darkvision) increases by 60 feet, and it gains proficiency in [Perception](5E2014官方资源/规则/skills.md#Perception) if it lacks that proficiency. |
...
| dice: d8 | Malfunction |
|----------|-------------|
| 1 | **Faulty Sensors.** Roll a `d6` at the start of the clock work's turn. If you roll a 1, the clockwork is [blinded](5E2014官方资源/规则/conditions.md#blinded) until the end of its turn. |
...
| 7 | **Overheats.** Roll a `d6` at the start of the clockwork's turn. If you roll a 1, the clockwork is [incapacitated](5E2014官方资源/规则/conditions.md#incapacitated) until the end of its turn. |
...
***Harpoon.*** *Ranged Weapon Attack:* `+7` to hit, range 50/200 ft., one target. *Hit:* 9 (`1d10 + 4`) piercing damage, and the target is [grappled](5E2014官方资源/规则/conditions.md#grappled) (escape DC 12). While [grappled](5E2014官方资源/规则/conditions.md#grappled) in this way, a creature's speed isn't reduced, but it can move only in directions that bring it closer to the clockwork. A creature takes 5 (`1d10`) slashing damage if it escapes from the grapple or if it tries and fails. The clockwork can grapple only one creature at a time with its harpoon.
...
***Reel In.*** The clockwork pulls the creature [grappled](5E2014官方资源/规则/conditions.md#grappled) by its Harpoon up to 20 feet closer.
```
^statblock
