...
The thick plates of stone riveted onto a stone [defender](5E2014官方资源/items/defender.md) give it substantial protection. Its chief role is as a bodyguard.
...
***Slam.*** *Melee Weapon Attack:* `+6` to hit, reach 5 ft., one target. *Hit:* 11 (`2d6 + 4`) bludgeoning damage, and if the target is Large or smaller, it is knocked [prone](5E2014官方资源/规则/conditions.md#prone).
