...
**3/day each**: [dimension door](5E2014官方资源/spells/dimension-door.md) (self only), [plane shift](5E2014官方资源/spells/plane-shift.md) (self only)
...
***Stunning Roar (Recharge 5-6).*** The steel predator emits a roar in a 60-foot cone. Each creature in that area must make a DC 19 Constitution saving throw. On a failed save, a creature takes 33 (`6d10`) thunder damage, drops everything it's holding, and is [stunned](5E2014官方资源/规则/conditions.md#stunned) for 1 minute. The [stunned](5E2014官方资源/规则/conditions.md#stunned) creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success. On a successful save, a creature takes half as much damage and isn't [stunned](5E2014官方资源/规则/conditions.md#stunned).
```
^statblock
