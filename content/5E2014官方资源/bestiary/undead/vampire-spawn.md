...
*Stake to the Heart.* The vampire is destroyed if a piercing weapon made of wood is driven into its heart while it is [incapacitated](5E2014官方资源/规则/conditions.md#incapacitated) in its resting place.
...
***Bite.*** *Melee Weapon Attack:* `+6` to hit, reach 5 ft., one willing creature, or a creature that is [grappled](5E2014官方资源/规则/conditions.md#grappled) by the vampire, [incapacitated](5E2014官方资源/规则/conditions.md#incapacitated), or [restrained](5E2014官方资源/规则/conditions.md#restrained). *Hit:* 6 (`1d6 + 3`) piercing damage plus 7 (`2d6`) necrotic damage. The target's hit point maximum is reduced by an amount equal to the necrotic damage taken, and the vampire regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if this effect reduces its hit point maximum to 0.
