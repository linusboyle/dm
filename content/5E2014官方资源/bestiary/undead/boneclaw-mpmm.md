...
***Piercing Claw.*** *Melee Weapon Attack:* `+8` to hit, reach 15 ft., one target. *Hit:* 20 (`3d10 + 4`) piercing damage plus 11 (`2d10`) necrotic damage. If the target is a creature, the boneclaw can pull the target up to 10 feet toward itself, and the target is [grappled](5E2014官方资源/规则/conditions.md#grappled) (escape DC 14). The boneclaw has two claws. While a claw grapples a target, the claw can attack only that target.
...
***Shadow Stealth.*** While in dim light or darkness, the boneclaw takes the [Hide](5E2014官方资源/规则/actions.md#Hide) action.
