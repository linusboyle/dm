...
***Stench.*** Any creature other than a catoblepas that starts its turn within 10 feet of the catoblepas must succeed on a DC 16 Constitution saving throw or be [poisoned](5E2014官方资源/规则/conditions.md#poisoned) until the start of the creature's next turn. On a successful saving throw, the creature is immune to the Stench of any catoblepas for 1 hour.

## Actions

***Tail.*** *Melee Weapon Attack:* `+7` to hit, reach 10 ft., one target. *Hit:* 21 (`5d6 + 4`) bludgeoning damage, and the target must succeed on a DC 16 Constitution saving throw or be [stunned](5E2014官方资源/规则/conditions.md#stunned) until the start of the catoblepas's next turn.
