...
***Sticky Leg.*** *Melee Weapon Attack:* `+4` to hit, reach 5 ft., one Small or Tiny creature. *Hit:* The target is stuck to the steeder's leg and [grappled](5E2014官方资源/规则/conditions.md#grappled) (escape DC 12). The steeder can have only one creature [grappled](5E2014官方资源/规则/conditions.md#grappled) at a time.
```
^statblock
