...
***Bite.*** *Melee Weapon Attack:* `+7` to hit, reach 5 ft., one creature. *Hit:* 19 (`3d10 + 3`) psychic damage, and the target must succeed on a DC 15 Wisdom saving throw or be [stunned](5E2014官方资源/规则/conditions.md#stunned) for 1 minute. The [stunned](5E2014官方资源/规则/conditions.md#stunned) target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
