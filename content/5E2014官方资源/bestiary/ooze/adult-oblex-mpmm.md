...
**3/day each**: [charm person](5E2014官方资源/spells/charm-person.md) (as 5th-level spell), [detect thoughts](5E2014官方资源/spells/detect-thoughts.md), [hypnotic pattern](5E2014官方资源/spells/hypnotic-pattern.md)
...
While memory drained, the target must roll a `d4` and subtract the number rolled from its ability checks and attack rolls. Each time the target is memory drained beyond the first, the die size increases by one: the `d4` becomes a `d6`, the `d6` becomes a `d8`, and so on until the die becomes a `d20`, at which point the target becomes [unconscious](5E2014官方资源/规则/conditions.md#unconscious) for 1 hour. The effect then ends.
