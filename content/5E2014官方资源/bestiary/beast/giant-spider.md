...
---
# Giant Spider
*Source: Monster Manual p. 328, Tasha's Cauldron of Everything, The Book of Many Things. Available in the SRD and the Basic Rules.*  
...
***Web (Recharge 5-6).*** *Ranged Weapon Attack:* `+5` to hit, range 30/60 ft., one creature. *Hit:* The target is [restrained](5E2014官方资源/规则/conditions.md#restrained) by webbing. As an action, the [restrained](5E2014官方资源/规则/conditions.md#restrained) target can make a DC 12 Strength check, bursting the webbing on a success. The webbing can also be attacked and destroyed (AC 10; hp 5; vulnerability to fire damage; immunity to bludgeoning, poison, and psychic damage).
```
^statblock
