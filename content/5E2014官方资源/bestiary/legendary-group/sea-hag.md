...
- The hag chooses one humanoid within the lair and instantly creates a simulacrum of that creature (as if created with the [simulacrum](5E2014官方资源/spells/simulacrum.md) spell). This hideous simulacrum is formed out of seaweed, slime, half-eaten fish, and other garbage, but still generally resembles the creature it is imitating. This simulacrum obeys the hag's commands and is destroyed on initiative count 20 on the next round.  
...
- Beasts that have an Intelligence score of 2 or lower are [charmed](5E2014官方资源/规则/conditions.md#charmed) by the hag and directed to be aggressive toward intruders in the area.  
