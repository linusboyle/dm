...
***Dazzling Slam.*** *Melee Weapon Attack:* `+4` to hit, reach 5 ft., one target. *Hit:* 5 (`1d6 + 2`) bludgeoning damage plus 7 (`2d6`) psychic damage, and the target is [blinded](5E2014官方资源/规则/conditions.md#blinded) until the start of the dolphin's next turn.
