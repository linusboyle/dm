...
- **Armor Class** 17 ([leather armor](5E2014官方资源/items/leather-armor.md), suave defense)
...
***Suave Defense.*** While the swashbuckler is wearing light or no armor and wielding no [shield](5E2014官方资源/items/shield.md), its AC includes its Charisma modifier.
...
***Lightfooted.*** The swashbuckler takes the [Dash](5E2014官方资源/规则/actions.md#Dash) or [Disengage](5E2014官方资源/规则/actions.md#Disengage) action.
```
^statblock
