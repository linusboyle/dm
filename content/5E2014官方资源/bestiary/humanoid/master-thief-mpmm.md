...
***Evasion.*** If the thief is subjected to an effect that allows it to make a Dexterity saving throw to take only half damage, the thief instead takes no damage if it succeeds on the saving throw and only half damage if it fails, provided the thief isn't [incapacitated](5E2014官方资源/规则/conditions.md#incapacitated).
...
***Cunning Action.*** The thief takes the [Dash](5E2014官方资源/规则/actions.md#Dash), [Disengage](5E2014官方资源/规则/actions.md#Disengage), or [Hide](5E2014官方资源/规则/actions.md#Hide) action.
