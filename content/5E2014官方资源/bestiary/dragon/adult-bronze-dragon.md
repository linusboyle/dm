...
***Wing Attack (Costs 2 Actions).*** The dragon beats its wings. Each creature within 10 feet of the dragon must succeed on a DC 20 Dexterity saving throw or take 14 (`2d6 + 7`) bludgeoning damage and be knocked [prone](5E2014官方资源/规则/conditions.md#prone). The dragon can then fly up to half its flying speed.

![Bronze Dragon](5E2014官方资源/bestiary/legendary-group/bronze-dragon.md)
```
^statblock
