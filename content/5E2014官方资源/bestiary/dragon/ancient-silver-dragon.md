...
***Detect.*** The dragon makes a Wisdom ([Perception](5E2014官方资源/规则/skills.md#Perception)) check.

***Tail Attack.*** The dragon makes a tail attack.

***Wing Attack (Costs 2 Actions).*** The dragon beats its wings. Each creature within 15 feet of the dragon must succeed on a DC 25 Dexterity saving throw or take 17 (`2d6 + 10`) bludgeoning damage and be knocked [prone](5E2014官方资源/规则/conditions.md#prone). The dragon can then fly up to half its flying speed.

![Silver Dragon](5E2014官方资源/bestiary/legendary-group/silver-dragon.md)
```
^statblock
