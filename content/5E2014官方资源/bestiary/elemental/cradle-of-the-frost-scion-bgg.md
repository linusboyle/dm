...
***Awakening of the Scion.*** The cradle is a container for the [scion of Thrym](5E2014官方资源/bestiary/giant/scion-of-thrym-bgg.md). When the cradle drops to 0 hit points, its body shatters into shards of ice. The scion instantly appears in the space the cradle occupied and uses the cradle's initiative count.
...
***Hurl Icicle.*** *Ranged Weapon Attack:* `+15` to hit, range 120 ft., one target. *Hit:* 26 (`4d8 + 8`) piercing damage plus 9 (`2d8`) cold damage, and the target must succeed on a DC 23 Strength saving throw or have the [prone](5E2014官方资源/规则/conditions.md#prone) condition.

***Freezing Breath (Recharge 5-6).*** The cradle exhales a blast of frost in a 90-foot cone. Each creature in that area must make a DC 23 Constitution saving throw. On a failed save, a creature takes 52 (`8d12`) cold damage, and its speed is reduced to 0 until the end of its next turn. On a successful save, a creature takes half as much damage only. If this damage would reduce the target to 0 hit points, the target drops to 1 hit point instead and has the [petrified](5E2014官方资源/规则/conditions.md#petrified) condition, turning into a frozen statue.
...
![Scion of Thrym](5E2014官方资源/bestiary/legendary-group/scion-of-thrym-bgg.md)
```
^statblock