...
The trip wire is 3 inches off the ground and stretches between two support beams. The DC to spot the trip wire is 10. A successful DC 15 Dexterity check using [thieves' tools](5E2014官方资源/items/thieves-tools.md) disables the trip wire harmlessly. A character without [thieves' tools](5E2014官方资源/items/thieves-tools.md) can attempt this check with disadvantage using any edged weapon or edged tool. On a failed check, the trap triggers.
