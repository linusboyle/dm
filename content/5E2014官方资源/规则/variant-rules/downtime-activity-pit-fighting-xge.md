...
The character makes three checks: Strength ([Athletics](5E2014官方资源/规则/skills.md#Athletics)), Dexterity ([Acrobatics](5E2014官方资源/规则/skills.md#Acrobatics)), and a special Constitution check that has a bonus equal to a roll of the character's largest Hit Die (this roll doesn't spend that die). If desired, the character can replace one of these skill checks with an attack roll using one of the character's weapons. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Pit Fighting Results table to see how the character did.

![Pit Fighting Results](5E2014官方资源/tables/pit-fighting-results-xge.md)
...
![Pit Fighting Complications](5E2014官方资源/tables/pit-fighting-complications-xge.md)