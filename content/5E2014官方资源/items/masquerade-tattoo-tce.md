...
As an action, you can use the tattoo to cast the [disguise self](5E2014官方资源/spells/disguise-self.md) spell (DC 13 to discern the disguise). Once the spell is cast from the tattoo, it can't be cast from the tattoo again until the next dawn.
