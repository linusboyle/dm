...
- 1 [major detrimental](5E2014官方资源/tables/artifact-properties-major-detrimental-properties.md) property  

## Spells

The book has 8 charges. It regains `1d8` expended charges daily at dawn. While holding it, you can use an action to cast [Tasha's hideous laughter](5E2014官方资源/spells/tashas-hideous-laughter.md) from it or to expend 1 or more of its charges to cast one of the following spells (save DC 20) from it: [magic circle](5E2014官方资源/spells/magic-circle.md) (1 charge), [magic jar](5E2014官方资源/spells/magic-jar.md) (3 charges), [planar ally](5E2014官方资源/spells/planar-ally.md) (3 charges), [planar binding](5E2014官方资源/spells/planar-binding.md) (2 charges), [plane shift](5E2014官方资源/spells/plane-shift.md) (to layers of the Abyss only; 3 charges), [summon fiend](5E2014官方资源/spells/summon-fiend-tce.md) (3 charges).

## Abyssal Reference

You can reference the *Demonomicon* whenever you make an Intelligence check to discern information about demons or a Wisdom ([Survival](5E2014官方资源/规则/skills.md#Survival)) check related to the Abyss. When you do so, you can add double your proficiency bonus to the check.
...
While carrying the book, whenever you cast the [magic circle](5E2014官方资源/spells/magic-circle.md) spell naming only fiends, or the [planar binding](5E2014官方资源/spells/planar-binding.md) spell targeting a fiend, the spell is cast at 9th level, regardless of what level spell slot you used, if any. Additionally, the fiend has disadvantage on its saving throw against the spell.

## Containment

The first 10 pages of the *Demonomicon* are blank. As an action while holding the book, you can target a fiend that you can see that is trapped within a [magic circle](5E2014官方资源/spells/magic-circle.md). The fiend must succeed on a DC 20 Charisma saving throw with disadvantage or become trapped within one of the *Demonomicon's* empty blank pages, which fills with writing detailing the trapped creature's widely known name and depravities. Once used, this action can't be used again until the next dawn.
