...
The *Axe of the Dwarvish Lords* is a magic weapon that grants a +3 bonus to attack and damage rolls made with it. The axe also functions as a [belt of dwarvenkind](5E2014官方资源/items/belt-of-dwarvenkind.md), a [dwarven thrower](5E2014官方资源/items/dwarven-thrower.md), and a [sword of sharpness](5E2014官方资源/items/sword-of-sharpness.md).
...
- The range of your [darkvision](5E2014官方资源/规则/senses.md#darkvision) increases by 60 feet.  
- You gain proficiency with [artisan's tools](5E2014官方资源/items/artisans-tools.md) related to blacksmithing, brewing, and stonemasonry.  

## Conjure Earth Elemental

If you are holding the axe, you can use your action to cast the [conjure elemental](5E2014官方资源/spells/conjure-elemental.md) spell from it, summoning an [earth elemental](5E2014官方资源/bestiary/elemental/earth-elemental.md). You can't use this property again until the next dawn.

## Travel the Depths

You can use an action to touch the axe to a fixed piece of dwarven stonework and cast the [teleport](5E2014官方资源/spells/teleport.md) spell from the axe. If your intended destination is underground, there is no chance of a mishap or arriving somewhere unexpected. You can't use this property again until 3 days have passed.

## Curse

The axe bears a curse that affects any non-dwarf that becomes attuned to it. Even if the attunement ends, the curse remains. With each passing day, the creature's physical appearance and stature become more dwarflike. After seven days, the creature looks like a typical dwarf, but the creature neither loses its racial traits nor gains the racial traits of a dwarf. The physical changes wrought by the axe aren't considered magical in nature (and therefore can't be dispelled), but they can be undone by any effect that removes a curse, such as a [greater restoration](5E2014官方资源/spells/greater-restoration.md) or [remove curse](5E2014官方资源/spells/remove-curse.md) spell.
