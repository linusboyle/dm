...
The orb has 7 charges and regains `1d4 + 3` expended charges daily at dawn. If you control the orb, you can use an action and expend 1 or more charges to cast one of the following spells (save DC 18) from it: [cure wounds](5E2014官方资源/spells/cure-wounds.md) (5th-level version, 3 charges), [daylight](5E2014官方资源/spells/daylight.md) (1 charge), [death ward](5E2014官方资源/spells/death-ward.md) (2 charges), or [scrying](5E2014官方资源/spells/scrying.md) (3 charges). You can also use an action to cast the [detect magic](5E2014官方资源/spells/detect-magic.md) spell from the orb without using any charges.
...
An Orb of Dragonkind appears fragile but is impervious to most damage, including the attacks and breath weapons of dragons. A [disintegrate](5E2014官方资源/spells/disintegrate.md) spell or one good hit from a +3 magic weapon is sufficient to destroy an orb, however.
