...
You can use this trait to take the [Help](5E2014官方资源/规则/actions.md#Help) action as a bonus action, and you can do so a number of times equal to your proficiency bonus. You regain all expended uses when you finish a long rest.

Starting at 3rd level, choose one of the options below each time you take the [Help](5E2014官方资源/规则/actions.md#Help) action with this trait:
