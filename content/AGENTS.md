...
1. This is an Obsidian Vault, so make sure the Markdown syntax is compatible.
2. Use Obsidian CLI to determine currently opened file, if needed.
3. It is very possible that I modify notes. Always read content of a note, instead of relying on cached text in conversation history.
